...
يتقاضى الطرف الثاني راتبًا أساسيًا شهريًا قدره (${input.salary.toLocaleString()} دينار أردني) يُدفع في نهاية كل شهر ميلادي، مع أي بدلات تقررها الشركة وفق السياسات الداخلية.
